      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div
          :class="[
            ...
            isMounted ? 'animate-fade-in-left opacity-100' : 'opacity-0',
          ]"
        ...
        <div
          :class="[
            'flex justify-center lg:justify-end transition-all duration-600',
            isMounted ? 'animate-fade-in-scale opacity-100' : 'opacity-0',
          ]"
